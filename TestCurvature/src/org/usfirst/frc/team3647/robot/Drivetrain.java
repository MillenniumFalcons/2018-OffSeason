...
//		rightSRX.configPeakCurrentLimit(amps, 10);
	...
	public static void testCurvature(boolean buttonX, boolean buttonY, boolean buttonA, boolean buttonB, boolean rightBumper, boolean leftBumper)
	{
		String character = "";
		if(buttonX)
		{
			drive.curvatureDrive(1, .16, true);
			Timer.delay(.5);
			character += "Left Speed: ";
			character += Double.toString(leftSRX.get());
			character += "; ";
			character += "Right Speed: ";
			character += Double.toString(rightSRX.get());
			character += "; ";
			array[0] = character;
		}
		else if(buttonY)
		{
			drive.curvatureDrive(1, .33, true);
			Timer.delay(.5);
			character += "Left Speed: ";
			character += Double.toString(leftSRX.get());
			character += "; ";
		...
		{
			drive.curvatureDrive(1, .66, true);
			Timer.delay(.5);
			character += "Left Speed: ";
			character += Double.toString(leftSRX.get());
			character += "; ";
		...
		{
			drive.curvatureDrive(1, .83, true);
			Timer.delay(.5);
			character += "Left Speed: ";
			character += Double.toString(leftSRX.get());
			character += "; ";
