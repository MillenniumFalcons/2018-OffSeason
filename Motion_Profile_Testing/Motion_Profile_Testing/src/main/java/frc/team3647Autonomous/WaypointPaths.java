...
public class WaypointPaths
{
    public static Trajectory middleToRightSwitch()
    {
        ...
        Trajectory.Config configPoints = new Trajectory.Config(Trajectory.FitMethod.HERMITE_CUBIC, Trajectory.Config.SAMPLES_LOW, Constants.MPTimeStep, 10, 5, Constants.maxJerk); //fit, samples, timestep, velocity, acceleration, jerk
